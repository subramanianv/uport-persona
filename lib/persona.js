...
class Persona {
  ...
  /**
   *  This should be the only function ever used to set attributes onto the blockchain. This can be overridden in
   *  a subclass.
   *
  ...
  addClaims(tokensList) {
    // console.log(tokensList[0])
    // let token = tokensList[0];
